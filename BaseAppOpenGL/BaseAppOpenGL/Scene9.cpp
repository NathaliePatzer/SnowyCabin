...
int CScene9::DrawGLScene(void)	// Função que desenha a cena
{
	// Get FPS
...
void CScene9::MouseMove(void) // Tratamento de movimento do mouse
{
...
void CScene9::KeyPressed(void) // Tratamento de teclas pressionadas
{
...
void CScene9::KeyDownPressed(WPARAM	wParam) // Tratamento de teclas pressionadas
{
	switch (wParam)
	{
	case VK_TAB:
...
void CScene9::Draw3DSGrid(float width, float length)
{
...
void CScene9::CreateSkyBox(float x, float y, float z,
